...
app.factory('startupsFactory', function ($http) {
    // var obj = [
    // 			{title:'vijayawada',content:'With supporting text below as a natural lead-in to additional content.'},
    // 			{title:'Machilipatnam',content:'With supporting text below as a natural lead-in to additional content.'}
    // 		  ];
